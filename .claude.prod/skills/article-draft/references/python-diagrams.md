...
Reference script: `${CLAUDE_PLUGIN_ROOT}/scripts/diagrams_event_driven.py`
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/scripts/add_branding.py" --image data/articles/<YYMMDD_slug>/diagram.png
```
