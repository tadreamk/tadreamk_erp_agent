...
| PUT | /job-applications/{application_id}/exercise-urls | Authenticated | Submit exercise URLs | [put_job-applications_{application_id}_exercise-urls.md](put_job-applications_{application_id}_exercise-urls.md) |
...
| PUT | /job-applications/admin/{application_id}/status | Admin/Moderator | Update application status | [put_job-applications_admin_{application_id}_status.md](put_job-applications_admin_{application_id}_status.md) |
| PUT | /job-applications/{application_id}/exercise | Admin/Moderator | Assign exercise to application | [put_job-applications_{application_id}_exercise.md](put_job-applications_{application_id}_exercise.md) |
...
| PUT | /job-applications/{application_id}/interview-schedule-admin | Admin/Moderator | Set interview schedule | [put_job-applications_{application_id}_interview-schedule-admin.md](put_job-applications_{application_id}_interview-schedule-admin.md) |
| PUT | /job-applications/{application_id}/interview-schedule-finalize | Admin/Moderator | Finalize interview schedule | [put_job-applications_{application_id}_interview-schedule-finalize.md](put_job-applications_{application_id}_interview-schedule-finalize.md) |
| PUT | /job-applications/{application_id}/interview-accept | Authenticated (candidate) | Accept interview time | [put_job-applications_{application_id}_interview-accept.md](put_job-applications_{application_id}_interview-accept.md) |
