...
| PATCH | /job-applications/{application_id}/interview-accept | Authenticated (candidate) | Accept interview time | [patch_job-applications_{application_id}_interview-accept.md](patch_job-applications_{application_id}_interview-accept.md) |
