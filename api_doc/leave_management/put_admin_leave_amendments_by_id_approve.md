...
Approve a pending leave amendment request. For `cancel` amendments, the original leave request is cancelled. For `change` amendments, the leave periods are updated. Sends a notification to the requesting employee.
