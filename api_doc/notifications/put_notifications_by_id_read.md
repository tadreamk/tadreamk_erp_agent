...
Mark a notification as read. Only the notification recipient can perform this action. Broadcasts an `unread_count_update` WebSocket event for cross-tab synchronization.
...
```json
{
  ...
  "is_read": true,
  "read_at": "2026-03-10T09:00:00+00:00",
  "is_dismissed": false
}
```
